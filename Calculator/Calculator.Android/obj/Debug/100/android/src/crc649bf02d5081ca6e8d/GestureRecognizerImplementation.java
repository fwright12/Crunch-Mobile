...
public class GestureRecognizerImplementation
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Calculator.Droid.GestureRecognizerImplementation, Calculator.Android", GestureRecognizerImplementation.class, __md_methods);
	}


	public GestureRecognizerImplementation ()
	{
		super ();
		if (getClass () == GestureRecognizerImplementation.class)
			mono.android.TypeManager.Activate ("Calculator.Droid.GestureRecognizerImplementation, Calculator.Android", "", this, new java.lang.Object[] {  });
	}
