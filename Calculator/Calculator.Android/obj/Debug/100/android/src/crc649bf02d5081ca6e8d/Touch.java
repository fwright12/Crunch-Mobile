...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Calculator.Droid.Touch, Calculator.Android", Touch.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == Touch.class)
			mono.android.TypeManager.Activate ("Calculator.Droid.Touch, Calculator.Android", "", this, new java.lang.Object[] {  });
	}
