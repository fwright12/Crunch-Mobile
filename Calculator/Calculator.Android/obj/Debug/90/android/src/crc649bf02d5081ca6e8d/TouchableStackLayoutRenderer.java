...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Calculator.Droid.TouchableStackLayoutRenderer, Calculator.Android", TouchableStackLayoutRenderer.class, __md_methods);
	}
	...
	public TouchableStackLayoutRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		...
		if (getClass () == TouchableStackLayoutRenderer.class)
			mono.android.TypeManager.Activate ("Calculator.Droid.TouchableStackLayoutRenderer, Calculator.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
