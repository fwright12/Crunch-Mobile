...
namespace Calculator
{
    ...
    public class FourFuncCalculator : ICalculator
    {
    ...
    {
        public static readonly BindableProperty CalculatorProperty = BindableProperty.Create(nameof(Calculator), typeof(ICalculator), typeof(BasicCalcViewModel), new FourFuncCalculator());
