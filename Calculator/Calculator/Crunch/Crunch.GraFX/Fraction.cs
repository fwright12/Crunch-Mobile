...
namespace Crunch.GraFX
{
    public class Fraction : Expression
    {
        ...
        public Fraction(View numerator, View denominator) : base()
        {
            ...
            Numerator = (numerator is Expression) ? numerator as Expression : new Expression(numerator);
            Denominator = (denominator is Expression) ? denominator as Expression : new Expression(denominator);
