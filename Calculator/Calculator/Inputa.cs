...
namespace Calculator
{
    /*public class Input
    {
        ...
        public static List<Symbol> text
        {
            get
            {
                return selected.tedxt;
            }
        }
        ...
        public List<Symbol> tedxt = new List<Symbol>() { Symbol.Cursor };
        ...
        private static void Insert(Symbol sender)
        {
            Insert(pos, sender);
        }

        private static void Insert(int index, Symbol sender)
        {
        ...
        public static void SendKeystroke(string s)
        {
            switch (s)
            {
                case "^":
        ...
        private static void parend(int index, int isNull = 1)
        {
